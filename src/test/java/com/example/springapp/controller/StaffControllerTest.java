...
public class StaffControllerTest {
	    ...
	    Staff mockValue=new Staff(1L,"abc",30L,"female","chennai","98989889","Doctor","abcAgmail.com",10L,"benefits");
	    Staff mockValue1=new Staff(2L,"abcg",30L,"female","chennai","989","Doctor","abcgAgmail.com",15L,"benefits");

	    
        List<Staff> list=Arrays.asList(mockValue,mockValue1);
	    
	    // String st = "{\"id\":1,\"name\":\"Medicine\",\"quantity\":20L,\"category\":\"fever\",\"prive\":20L,\"supplier\":\"Para\"}";

	    Optional<Staff> optinalMock= Optional.ofNullable(mockValue);
	    ...
	    public void testGetById() throws Exception {
	     ...
	     given(service.getStaffById(Id)).willReturn(optinalMock);
	    ...
	    public void testGetAll() throws Exception {
	        ...
	        Mockito.when(service.getAllStaff()).thenReturn(list);
	        mockMvc.perform(get("/staff"))
	        .andExpect(MockMvcResultMatchers.status().isOk())
	        .andDo(print())
            .andExpect(content().contentType("application/json"))
	    ...
	    public void testCreate() throws Exception {
	     ...
	     //  Mockito.when(InventoryService.saveInventory(inventory)).thenReturn(inventory);
	        mockMvc.perform(MockMvcRequestBuilders.post("/staff")
	                ...
	                .content(asJsonString(mockValue)))
	    ...
	    public void testDeletePharmacy() throws Exception {
	    	...
	    	String id="1";
    		mockMvc.perform(MockMvcRequestBuilders.delete("/staff")
    				.param("id", id))
    						.andDo(print())
